...
// mstapp - I'm disabling fullscreen mode
// ---------------
// ---------------
// BEGIN disabled fullscreen section #1
...
// ---------------
// ---------------
// END disabled fullscreen section #1
...
GA.plugins = function(ga) {
  ...
  */
  ...
  // mstapp - disabling this (deprecated -- see above)
  // ---------------
  // ---------------
  // BEGIN disabled burst
  ...
  */
  ...
  ga.fourKeyController = function(s, speed, up, right, down, left) {
    ...
    var leftArrow = ga.keyboard(left);
    var upArrow = ga.keyboard(up);
    var rightArrow = ga.keyboard(right);
    var downArrow = ga.keyboard(down);
  ...
  */
  ...
  // ---------------
  // ---------------
  // BEGIN disabled fullscreen section #2
  ...
  // ---------------
  // ---------------
  // END disabled fullscreen section #2
...
export default 1; // junk; just to export something
